...
def inference(inp_img, num_output_channel):
    ################################################################################
    # TODO:                                                                        #
    # The code below is a implementation of hourglass                              #
    # Now you are asked to change it into associate embedding model.               #
    # Make sure that the number of your output channels is num_output_channel      #
    ################################################################################
    f = 256
    kps = 17
